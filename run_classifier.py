...
flags.DEFINE_float("num_train_epochs", 20,
...
class SimProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        for idx, (t, l) in enumerate(zip(text, label)):
            train_data.append(InputExample(
                guid='train-%d' % idx, text_a=tokenization.convert_to_unicode(t), text_b=None, label=l))  # 加入到InputExample列表中
        return train_data
    ...
    def get_dev_examples(self, data_dir):
        ...
        for idx, (t, l) in enumerate(zip(text, label)):
            train_data.append(InputExample(
                guid='dev-%d' % idx, text_a=tokenization.convert_to_unicode(t), text_b=None, label=l))  # 加入到InputExample列表中
        return train_data
    ...
    def get_test_examples(self, data_dir):
        ...
        for idx, (t, l) in enumerate(zip(text, label)):
            train_data.append(InputExample(
                guid='test-%d' % idx, text_a=tokenization.convert_to_unicode(t), text_b=None, label=l))  # 加入到InputExample列表中
        return train_data

    def get_labels(self, data_dir):
        df = pd.read_csv(data_dir + 'train.tsv', sep='\t')
        return list(df.iloc[:, 0].unique())
